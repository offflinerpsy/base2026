...
| TikTok transcript queue `config/tiktok-intake-queue.20260608.json` | staged | no git unless reviewed | 68 URLs checked through `yt-dlp` metadata extraction; 26 caption-ready candidates; 36 need ASR. |
