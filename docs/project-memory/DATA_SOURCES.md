...
| `public-data/tiktok` | generated local export | no git | Latest local export after ay57 reviewed-card deploy: 1214 source records, 1707 passages, 1552 insight cards, 1460 topics, 4 creators, 1111 public insight cards. Public release payload is excerpt-only by default and not committed. Deployed as `base2026-reviewed-cards-ay57-20260612`. |
| Meilisearch index `base2026_public_tiktok` | deployed runtime | public search only | Search key only; master key private. Reindexed during `base2026-reviewed-cards-ay57-20260612` deploy with 1707 passages. |
