...
- latest deployed release: `base2026-entity-qa-cleanup-ay64-20260612`
...
- `base2026-entity-qa-cleanup-ay64-20260612` is live after the post-ay63 no-new-video scan and a source-backed transcript QA cleanup slice. The cleanup added durable normalizations for public ASR/entity artifacts, marked 11 reviewed entity rows as QA pass through an explicit private manifest, rebuilt/exported public data, deployed, and reindexed Meilisearch.
- Current ay64 public export is excerpt-only with 1215 source records, 1708 passages, 1553 insight cards, 1113 public insight cards, 1460 topics, and 1054 public topics. Meilisearch reindexed 1708 passages.
...
- Live ay64 QA passed: public export policy, SQLite rebuild/audit, transcript QA triage, publication boundary audit, GitHub metadata validation, live targeted source-page entity smoke checks, live public JSONL ASR-slop scan, Meilisearch indexing, and full mixed mobile visual QA with 66 checks and 0 failures.
...
- `base2026-entity-qa-cleanup-ay64-20260612` is live after source-backed entity QA cleanup, rebuild/export, deploy, and Meilisearch reindex with 1708 passages.
- ay64 public export counts: 1215 source records, 1708 passages, 1553 insight cards, 1113 public insight cards, 1460 topics, 1054 public topics, 4 creators.
- ay64 live QA passed: public export policy clean, live target source pages contain corrected entity/product names, live JSONL ASR-slop scan found 0 tracked bad patterns, and mobile visual QA passed 66 checks with 0 failures.
...
- current transcript QA triage after ay64: 626 private review flags: 611 audio-verification rows, 6 entity/spelling rows, and 9 human text-review rows.
