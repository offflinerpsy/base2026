...
- latest deployed release: `base2026-tiktok-refresh-ay50-20260611`
...
- `base2026-tiktok-refresh-ay50-20260611` is live after the MacBook TikTok refresh pass. Public export is excerpt-only with 1209 source records, 1373 passages, 1538 insight cards, 1097 public insight cards, 1442 topics, and 1040 public topics. Meilisearch reindexed 1373 passages.
- The ay50 pipeline pass discovered the broader `@joshuamaraney` archive: 3008 total TikTok inventory rows, 1209 active rows, 167 queued transcripts, 99 `needs_asr`, 941 transcribed rows, and 266 queued ASR jobs after clean SQLite rebuild. One caption-ready transcript, `tiktok-video-7648365806375488782`, was polished and exported as a public source excerpt.
