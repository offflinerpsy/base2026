...
2. verifying source/creator identity if needed;
3. correcting, hiding, or removing the record when appropriate;
4. logging the decision internally;
5. adding suppression where necessary.
